...
// the tool. Set THESPIN_KEY to earn your revenue share for the impression.
//
//   env: THESPIN_URL (default https://thespin.ad), THESPIN_KEY (optional publisher key)
...
server.tool(
  ...
  async () => {
    try {
      ...
      const text = ad?.line
        ? `◆ ${ad.line}  ${ad.price_per_1k}/1k [ad]\n${ad.click_url || THESPIN_URL}`
        : `◆ thespin · spinner unclaimed — bid at ${THESPIN_URL}`;
